        ...
        <el-scrollbar>
          ...
          >
            ...
            <el-sub-menu index="entity">
              ...
              <el-menu-item index="/entity">物品列表</el-menu-item>
              <el-menu-item index="/entity/add">添加物品</el-menu-item>
            </el-sub-menu>
            ...
            <el-dropdown trigger="click" @command="handleCommand">
              <div class="user-info">
                <el-avatar :size="32" :src="userInfo.avatar" v-if="userInfo.avatar">
                  {{ userInfo.nickname ? userInfo.nickname.substring(0, 1) : userInfo.username.substring(0, 1) }}
                </el-avatar>
                <el-avatar :size="32" icon="el-icon-user" v-else></el-avatar>
                <span class="username" v-if="!isSmallScreen">{{ userInfo.nickname || userInfo.username }}</span>
...
import { 
  HomeFilled, Box, Collection, Promotion, Bell, Setting, User, Lock, 
...
export default defineComponent({
  ...
  components: {
    HomeFilled, Box, Collection, Promotion, Bell, Setting, User, Lock,
    SwitchButton, Fold, Expand, FullScreen, ArrowDown, InfoFilled,
    WarningFilled, CircleCheckFilled, Breadcrumb
  },
  setup() {
